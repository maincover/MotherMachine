...
*/
public class Ins_ParticleAnalyzer implements PlugInFilter, Measurements {
	...
	public double staticMinSize = 0.0;
	...
	*/
	public Ins_ParticleAnalyzer(int options, int measurements, ResultsTable rt, double minSize, double maxSize, double minCirc, double maxCirc) {
	...
	public Ins_ParticleAnalyzer(int options, int measurements, ResultsTable rt, double minSize, double maxSize) {
	...
	/** Default constructor */
	public Ins_ParticleAnalyzer(int slice) {
		this.slice = slice;
	}
	...
	public int setup(String arg, ImagePlus imp) {
		this.arg = arg;
		this.imp = imp;
		IJ.register(Ins_ParticleAnalyzer.class);
		if (imp==null)
		...
		processStack = false;//(flags&DOES_STACKS)!=0;
		//slice = 0;
		saveRoi = imp.getRoi();
	...
	public boolean showDialog() {
		...
		minCircularity = 0.0;//staticMinCircularity;
		...
		labels[0]="Display results"; states[0] = true;//(options&SHOW_RESULTS)!=0;
		...
		labels[6]="Add to Manager"; states[6]=true;//(options&ADD_TO_MANAGER)!=0;
	...
	public boolean analyze(ImagePlus imp, ImageProcessor ip) {
		Analyzer.setMeasurements(measurements|RECT|AREA|CIRCULARITY);
