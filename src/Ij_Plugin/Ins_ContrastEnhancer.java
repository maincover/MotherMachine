...
public class Ins_ContrastEnhancer implements PlugIn, Measurements {

	int max, range;
	boolean classicEqualization;
	int stackSize;
	boolean updateSelectionOnly;
	boolean equalize, normalize=true, processStack, useStackHistogram, entireImage;
	static double saturated = 0.1;
	static boolean gEqualize = false;
	static boolean gNormalize = true;
