...
*/
public class FftBandPassFilter implements  PlugInFilter, Measurements {
	...
	private static double filterLargeDia = 10.0;
	...
	public void setLargeSmallFilterSize(int large, int small)
	{
