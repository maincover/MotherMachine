...
public class Ins_ThresholdAdjuster extends PlugInDialog implements PlugIn, Measurements,
	...
	static Ins_ThresholdAdjuster instance; 
	static int mode = RED;	
    ...
    public static void update() {
		if (instance!=null) {
			Ins_ThresholdAdjuster ta = ((Ins_ThresholdAdjuster)instance);
			ImagePlus imp = WindowManager.getCurrentImage();
...
class ThresholdPlot extends Canvas implements Measurements, MouseListener {
	...
	public void paint(Graphics g) {
		...
		g.setColor(Color.black);
 		...
 		if (mode==Ins_ThresholdAdjuster.RED)
			g.setColor(Color.red);
		else if (mode==Ins_ThresholdAdjuster.OVER_UNDER) {
	...
	public static void main(String[] args)
	{
		...
		if(imp == null)
			return;
		imp.show();
		Ins_ThresholdAdjuster thresholdAdjuster = new Ins_ThresholdAdjuster();
