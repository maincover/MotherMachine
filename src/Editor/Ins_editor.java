...
public class Ins_editor extends PlugInFrame implements ActionListener, ItemListener,
    ...
    private static Ins_editor instance;
	...
	public Ins_editor(int rows, int columns, int fontSize, int options) {
		super("Editor");
	...
	public static Ins_editor getInstance() {
		return instance;
	}
